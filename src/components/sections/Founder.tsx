...
export default function Founder() {
  ...
  return (
    <section ref={ref} id="historia" className="py-28 overflow-hidden" style={{ background: 'linear-gradient(180deg, #ffffff 0%, #faf5ff 100%)' }}>
        ...
        <div className="grid md:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <div className="relative">
              ...
              <div className="absolute inset-0 translate-x-4 translate-y-4 rounded-3xl border border-[#a855f7]/20" />

              {/* Main photo area */}
              <div className="relative rounded-3xl overflow-hidden bg-gradient-to-br from-[#f5f3ff] to-[#ede9fe] aspect-[4/5]">
                {/* Abstract founder portrait */}
                <div className="absolute inset-0 flex items-end justify-center pb-12">
                  <motion.div style={{ y }} className="flex flex-col items-center">
                    {/* Head */}
                    <div className="w-24 h-24 rounded-full bg-gradient-to-br from-[#e8c4b8] to-[#a855f7]/60 border-2 border-[#a855f7]/30 shadow-lg overflow-hidden relative">
                      {/* Hair */}
                      <div className="absolute -top-2 -left-2 -right-2 h-14 bg-gradient-to-br from-[#7c3aed] to-[#4c1d95] rounded-t-full" />
                      {/* Face highlight */}
                      <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-14 h-16 bg-gradient-to-b from-[#f0d5c0] to-[#e8c4b8] rounded-full" />
                    </div>
                    {/* Shoulders / body */}
                    <div className="w-40 h-36 rounded-t-[60px] bg-gradient-to-b from-[#a855f7]/50 to-[#7c3aed]/35 -mt-2 shadow-inner" />
                  </motion.div>
                </div>
                ...
                <div className="absolute bottom-6 left-6 right-6">
                  <div className="glass-card rounded-2xl px-5 py-3">
                    ...
                    <div className="text-xs text-[#a855f7] font-medium">Fundadora & Formuladora</div>
                  </div>
                </div>
              </div>
            </div>
            ...
            >
              ...
              <div className="text-xs text-[#a855f7]">Best Hair Brand 2024</div>
            </motion.div>
          </motion.div>
          ...
          >
            ...
            {/* Signature */}
            <div className="border-t border-[#ede9fe] pt-6 mb-8">
            ...
            <div className="grid grid-cols-3 gap-6">
              {[
                ...
                <div key={stat.label} className="text-center p-4 rounded-2xl bg-[#faf5ff] border border-[#ede9fe]">
                  <div className="font-serif text-2xl font-bold text-[#a855f7] mb-1">{stat.value}</div>
