...
export default function EmailCapture() {
  ...
  return (
    <section id="contacto" className="py-28 bg-gradient-to-br from-[#fafaf9] to-[#f0ece8]">
      <div className="max-w-3xl mx-auto px-6 text-center">
        ...
        >
          <motion.div
            variants={fadeUp}
            className="inline-flex items-center gap-2 bg-[#c9a96e]/10 rounded-full px-4 py-2 mb-8"
          >
          ...
          {!submitted ? (
            ...
            >
              <input
                ...
                required
                className="flex-1 px-5 py-4 rounded-full border border-[#e8d5b5] bg-white text-[#1a1a1a] placeholder-[#6b6b6b]/50 focus:outline-none focus:border-[#c9a96e] focus:ring-2 focus:ring-[#c9a96e]/20 transition-all text-sm"
              />
              <motion.button
                type="submit"
