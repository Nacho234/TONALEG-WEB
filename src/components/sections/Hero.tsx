...
export default function Hero() {
  ...
  return (
    <section id="hero" ref={ref} className="relative min-h-screen flex items-center overflow-hidden"
      style={{ background: 'linear-gradient(135deg, #faf5ff 0%, #f0e6ff 35%, #fce7f3 65%, #f5f3ff 100%)' }}
    >
      ...
      <motion.div style={{ y: bgY }} className="absolute inset-0 pointer-events-none">
        ...
        <div className="absolute inset-0" style={{
          background: `
            radial-gradient(ellipse 80% 60% at 70% 20%, rgba(168,85,247,0.25) 0%, transparent 60%),
            radial-gradient(ellipse 60% 50% at 20% 80%, rgba(236,72,153,0.20) 0%, transparent 55%),
            radial-gradient(ellipse 50% 40% at 90% 85%, rgba(20,184,166,0.15) 0%, transparent 50%),
            radial-gradient(ellipse 70% 60% at 10% 20%, rgba(139,92,246,0.18) 0%, transparent 60%)
          `
        }} />
        ...
        <motion.div
          ...
          style={{ background: 'radial-gradient(circle, rgba(168,85,247,0.30) 0%, rgba(139,92,246,0.12) 40%, transparent 70%)' }}
        />
        <motion.div
      ...
      <div className="relative max-w-7xl mx-auto px-6 py-32 grid md:grid-cols-2 gap-16 items-center">
        ...
        <motion.div style={{ y: textY }}>
          ...
          >
            <motion.div variants={fadeUp} className="inline-flex items-center gap-2 bg-[#a855f7]/10 border border-[#a855f7]/20 rounded-full px-4 py-2 mb-8">
            ...
            <motion.div variants={fadeUp} className="flex flex-wrap gap-4">
              ...
              <motion.a
                ...
                whileTap={{ scale: 0.97 }}
                className="inline-flex items-center gap-2 px-8 py-4 rounded-full text-base font-semibold border border-[#1a1a1a]/20 text-[#1a1a1a] hover:border-[#a855f7] hover:text-[#7c3aed] transition-all duration-300 bg-transparent"
              >
                Nuestra Historia
              </motion.a>
            </motion.div>

            <motion.div variants={fadeUp} className="flex items-center gap-0 mt-12 pt-8 border-t border-[#a855f7]/15">
              {[
                ...
                <div key={stat.label} className="flex items-center">
                  ...
                  {i < 2 && <div className="w-px h-10 bg-[#a855f7]/20 flex-shrink-0" />}
                </div>
              ))}
            </motion.div>
          </motion.div>
        ...
        >
          <div className="relative w-full max-w-md">
            <div className="absolute inset-0 bg-gradient-to-br from-[#a855f7]/20 via-[#c4b5fd]/15 to-[#ec4899]/20 rounded-[40px] transform rotate-3" />
            <div className="relative bg-white/80 rounded-[36px] p-10 shadow-2xl border border-[#a855f7]/15 backdrop-blur-sm">
              <div className="absolute top-6 right-6 w-16 h-16 rounded-full bg-[#a855f7]/10 flex items-center justify-center">
                <div className="w-8 h-8 rounded-full bg-[#a855f7]/20" />
              </div>
              ...
              <div className="flex flex-col items-center py-8 gap-6">
                ...
                <div className="flex flex-wrap gap-2 justify-center">
                  {['Argán', 'Queratina', 'Biotina'].map((ing) => (
                    <span key={ing} className="text-xs px-3 py-1.5 bg-[#f5f3ff] text-[#7c3aed] rounded-full font-medium border border-[#a855f7]/20">
                      {ing}
                    </span>
                  ))}
                </div>
            ...
            <motion.div
              ...
              className="absolute -right-6 top-1/3 rounded-2xl px-4 py-3 shadow-xl border border-[#a855f7]/15"
            ...
            <motion.div
              ...
              className="absolute -left-6 bottom-1/4 rounded-2xl px-4 py-3 shadow-xl border border-[#a855f7]/15"
              style={{ background: 'rgba(255,255,255,0.92)', backdropFilter: 'blur(12px)' }}
            >
